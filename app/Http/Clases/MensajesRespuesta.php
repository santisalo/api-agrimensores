...
class MensajesRespuesta
{
    const respuestas = [
        ...
        "ERROR_ENCONTRADO_REGISTRADO" => "Usuario ya existente, intente iniciando sesión",
        "ERROR_ENCONTRADO_DESHABILITADO" => "El usuario ingresado se encuentra deshabilitado, comuniquese con CPIA para la habilitación del mismo",
